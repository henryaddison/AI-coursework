...
minimax_move(Alive, OtherPlayerAlive, Move):-
	possible_moves(Alive, OtherPlayerAlive, PossMoves),
	trial_cranked_board_states(Alive, OtherPlayerAlive, PossMoves, TrialMoveOutcomes),
	best_minimax(TrialMoveOutcomes, _, Move, PredictedMove),
	write('predicted move: '),write(PredictedMove),nl.

best_minimax([[MineAlives, TheirAlives, Move]], BestMinimum, BestMove, PredictedMove):-
	BestMove = Move,
...
best_minimax([[MineAlives, TheirAlives, Move]], BestMinimum, BestMove, PredictedMove):-
	...
	most_land_grab(TrialTheirMoveOutcomes, TheirMinimum, PredictedMove),
...
best_minimax([[MineAlives, TheirAlives, Move]|RemainingOutcomes], BestMinimum, BestMove, PredictedMove):-
	best_minimax(RemainingOutcomes, RemainingBestMinimum, RemainingBestMove, RemainingPredictedMove),
	best_minimax([[MineAlives, TheirAlives, Move]], ThisBestMinimum, ThisBestMove, ThisPredictedMove),
	(ThisBestMinimum > RemainingBestMinimum -> (BestMove = ThisBestMove, BestMinimum = ThisBestMinimum, PredictedMove = ThisPredictedMove) ; (BestMove = RemainingBestMove, BestMinimum = RemainingBestMinimum, PredictedMove = RemainingPredictedMove)).
